...
export const newThinkers: Thinker[] = [
  ...
  // === Beginner-friendly additions ===
  {
    ...
    avatar: '🔬', schools: ['liberalism', 'political-philosophy'],
    oneLiner: '科学不能被证实，只能被证伪——真正的科学敢于冒被反驳的风险',
    biography: '波普尔是20世纪最有影响力的科学哲学家之一，也是自由主义的坚定捍卫者。他出身维也纳，因纳粹上台而流亡新西兰和英国。他提出了划时代的"证伪主义"：科学理论不是通过"证实"（找一百万个白天鹅也不能证明"所有天鹅都是白的"），而是通过"证伪"（看到一只黑天鹅，理论就被反驳了）来进步的。这一标准将科学与伪科学（精神分析、马克思主义）区分开来。在政治哲学上，他的《开放社会及其敌人》(1945)抨击了柏拉图、黑格尔和马克思的"历史决定论"——认为他们为极权主义提供了思想基础。',
    keyIdeas: ['证伪主义：科学理论必须是可被证伪的——敢于冒被反驳的风险才是科学', '开放社会：民主制度的核心不是"谁应该统治"而是"如何和平地推翻统治者"', '三个世界理论：物理世界、心理世界、客观知识世界（如数学定理）', '批判理性主义：理性不是"证明"而是"批判"——我们通过消除错误来接近真理'],
    majorWorks: ['《科学发现的逻辑》(1934)', '《开放社会及其敌人》(1945)', '《历史决定论的贫困》(1957)'],
    quotes: [{ text: '科学的游戏原则上没有终点。谁要是宣称他的理论被"证实"了，谁就退出了这个游戏。', source: '《科学发现的逻辑》' }],
    relatedThinkers: [{ id: 'hayek', relation: 'contemporary' }, { id: 'berlin', relation: 'contemporary' }],
    difficulty: 1,
  },
  {
